...
import numpy as np
from single_agent.Agent_common import AgentA2C
from single_agent.Model_common import ActorNetwork, CriticNetwork, A2CActorCriticNetwork
...
class MAA2C(AgentA2C):
    ...
    def __init__(self, env, state_dim, action_dim,
        ...
        if not self.shared_network:
            ...
            self.policy = A2CActorCriticNetwork(self.state_dim, self.action_dim, self.critic_hidden_size, 1, state_split)
            if optimizer_type == "adam":
